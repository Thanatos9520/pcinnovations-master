    ...
    <div class="container">
        ...
        <div class="col-lg-5">
           <h1 style=" border-style: double; border-color:#1d1d7e; ">Tarjeta de Video</h1>
               ...
               <div class="row">
        <div class="col-lg-12">
            <img src="img/Banner_Productos/1080ti.jpg" style="width:100%;">
        </div>
        </div>
<div style="height: 50px;"></div>
    ...
    <div id="A_Equipment" class="flex-container">
      ...
      <?php
       if($nro_pagina>1){
          echo "<a style='color:black;' href='gpu.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
       }
       ...
       if($nro_pagina<$can_paginas){
           echo "<a style='color:black;' href='gpu.php?num=".($nro_pagina+1)."'> Siguiente ></a> "; 
       }
       ?>
      </div>
      <!--End Pagination -->
