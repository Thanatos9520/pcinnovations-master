...
<html lang="en">
  ...
  font-family: Georgia, Cambria, Times, "Times New Roman";
    ...
    <?php include('conn.php');
     $query=mysqli_query($conn,"select * from product where categoryid = 5 order by product_name");  
    ...
    if(is_numeric($nro_pagina))
       ...
       $query=mysqli_query($conn,"select * from product where categoryid = 5 order by product_name limit $inicio,$reg_por_pagina");  
...
<div class="container">
    <div style="height: 50px;"></div>
     <h1 class="mt-4 mb-3">Memoria Ram
        <small></small>
      </h1>
