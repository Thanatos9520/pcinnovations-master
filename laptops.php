...
<html lang="en">
  ...
  <head>
    ...
    <?php include('conn.php');
     $query=mysqli_query($conn,"select * from product where categoryid = 12 order by product_name");  
    ...
    if(is_numeric($nro_pagina))
       ...
       $query=mysqli_query($conn,"select * from product where categoryid = 12 order by product_name limit $inicio,$reg_por_pagina");  
...
<div class="container">
    <div style="height: 50px;"></div>
     <h1 class="mt-4 mb-3">Laptops
        <small></small>
      </h1>
          <div class="row">
        <div class="col-lg-12">
            <img src="img/Banner_Productos/laptops.jpg" style="width:100%;">
        </div>
        </div>
    <div style="height: 50px;"></div>
      <ol class="breadcrumb">
  ...
  <div class="row">
	...
	?>
      ...
      <?php
          if($nro_pagina>1)
              echo "<a href='laptops.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
              
       for ($i=1; $i<=$can_paginas; $i++){
           if ($i==$nro_pagina)
               echo $i." ";
           else 
               echo "<a href='laptops.php?num=$i'>$i</a> ";
       } 
          
          if($nro_pagina<$can_paginas)
               echo "<a href='laptops.php?num=".($nro_pagina+1)."'> Siguiente ></a> ";
