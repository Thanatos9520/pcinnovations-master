...
<body>
    ...
    include('conn.php');
     $query=mysqli_query($conn,"select * from product where categoryid = 11 order by product_price");  
    ...
    if(is_numeric($nro_pagina))
       ...
       $query=mysqli_query($conn,"select * from product where categoryid = 11 order by product_price limit $inicio,$reg_por_pagina");  
    ...
    ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <h1 style=" border-style: double; border-color:#1d1d7e; ">Hogar / Oficina</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
