...
background-image: url("img/Fondo/gearblue.png");"
      ...
      <div class="container">
        ...
        <a class="navbar-brand" href="index.html"></a>
                <img src="img/logo_nav.png" href="index.php" width="70%" height="100%">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownService" >
                ...
                <a class="dropdown-item" href="">Equipment Deliver</a>
                          ...
                          if(!$_SESSION['id']==""){
                                echo ' 
                                     ...
                                     <li id="cartme" style="cursor:pointer">
                                        <button type="button" id="cartme" class="btn btn-info"><a id="cart_control">Cart <svg-icon><img src="svg/si-glyph-bag-plus.svg"/ style="width:24px; height:24px;"></button>
