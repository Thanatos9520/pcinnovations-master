    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3">
                <div style="height: 20px;"></div>
                <div class="link-area">
                    <h4 class="text-uppercase"><strong>Página Rápida</strong></h4>
                <!--     <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 85px;"> < !-- Esta linea era la linea de corrido de <a>inicio</a>-->
            ...
            <div class="col-md-3 col-xs-12">
                <div style="height: 20px;"></div>
                <div class="link-area">
                    <h4 class="text-uppercase"><strong>Mi Cuenta</strong></h4>
                    ...
                    <ul>
                        ...
                        echo ' 
                            ...
                            <li id="cartme" style="cursor:pointer">
                                <a class="nav-item nav-link" id="cart_control" title="Shopping Cart" data-toggle="popover" style="color:white">
                                    <img src="svg/si-glyph-trolley-2.svg"/ style="width:24px; height:24px;"> My Shopping Cart
                                </a>
                            </li>
                        ';
                        }else{
                        echo ' 
                            ...
                            <a class="dropdown-item" href="#myModal" data-toggle="modal" style="color:white">
                                <img src="svg/si-glyph-flower.svg"/ style="width:24px; height:24px;"> Mi Cuenta</a>
                            <a class="dropdown-item" href="#myModal" data-toggle="modal" style="color:white">
                                <img src="svg/si-glyph-man-doctor.svg"/ style="width:24px; height:24px;"> Mi Perfil</a>
                            <a class="nav-item nav-link" id="cart_control" title="Shopping Cart" data-toggle="popover" style="color:white">
                                <img src="svg/si-glyph-trolley-2.svg"/ style="width:24px; height:24px;"> My Shopping Cart</a>
                        ';
                        }
                        ?>   
                    </ul>
            ...
            <div class="col-md-3 col-xs-12">
                <div style="height: 20px;"></div>
                <div class="link-area">
                    <h4 class="text-uppercase"><strong>Contactenos</strong></h4>
