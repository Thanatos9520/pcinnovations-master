...
<body>
    ...
    include('conn.php');
     $query=mysqli_query($conn,"select * from product where categoryid = 10 order by product_price");  
    ...
    <div class="container">
        ...
        <!-- Page Heading/Breadcrumbs -->
          ...
          <div class="row">
        <div class="col-lg-3">
           <h1 style=" border-style: double; border-color:#1d1d7e; ">Cases</h1>
        </div>
        </div>
               <div class="row">
        <div class="col-lg-12">
...
<div style="height: 50px;"></div>
    ...
    <div id="A_Equipment" class="flex-container">
      ...
      <?php
       if($nro_pagina>1){
          echo "<a style='color:black;' href='case.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
       }
       ...
       if($nro_pagina<$can_paginas){
           echo "<a style='color:black;' href='case.php?num=".($nro_pagina+1)."'> Siguiente ></a> "; 
       }
       ?>
      </div>
      <!--End Pagination -->
