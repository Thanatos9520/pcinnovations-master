...
<body>
    ...
    include('conn.php');
    $query=mysqli_query($conn,"select * from product where categoryid = 13 order by product_price");  
    ...
    <div class="container">
        ...
        <!-- Page Heading/Breadcrumbs -->
          ...
          <div class="row">
        <div class="col-lg-4">
           <h1 style=" border-style: double; border-color:#1d1d7e; ">Discos Duros</h1>
        </div>
        </div>
               <div class="row">
        <div class="col-lg-12">
            <img src="img/Banner_Productos/ssd.jpg" style="width:100%;">
        </div>
        </div>
<div style="height: 50px;"></div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a style="color: #000;" href="index.php">Inicio</a></li>
                <li class="breadcrumb-item active">Discos Duros</li>
            </ol>  
    ...
    <div id="A_Equipment" class="flex-container">
      ...
      <?php
       if($nro_pagina>1){
          echo "<a style='color:black;' href='HDD.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
       }
       ...
       if($nro_pagina<$can_paginas){
           echo "<a style='color:black;' href='HDD.php?num=".($nro_pagina+1)."'> Siguiente ></a> "; 
       }
       ?>
      </div>
      <!--End Pagination -->
