...
<body>
    ...
    ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <h1 style=" border-style: double; border-color:#1d1d7e; ">Headset</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
          ...
          ?>
            ...
            <div align="center">
                <?php
       if($nro_pagina>1){
          echo "<a style='color:black;' href='headset.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
       }
       ...
       if($nro_pagina<$can_paginas){
           echo "<a style='color:black;' href='headset.php?num=".($nro_pagina+1)."'> Siguiente ></a> "; 
       }
       ?>
            </div>
            <!--End Pagination -->
