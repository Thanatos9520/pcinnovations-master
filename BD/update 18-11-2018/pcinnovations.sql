...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-11-2018 a las 04:46:50
...
(169, 12, 'Asus Vivobook x510', 370000, 10, 'upload/P_setting_fff_1_90_end_600.png.jpg', 10, '15.6\" 1tb 8gb i5-8250U 1366 x 768 resolución', 'No disponible', 'No disponible'),
...
--
ALTER TABLE `carousel`
  MODIFY `idphoto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1553;
--
...
--
ALTER TABLE `product`
  MODIFY `productid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=172;
--
