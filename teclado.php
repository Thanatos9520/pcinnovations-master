...
<div style="height: 50px;"></div>
      <div class="row">
        <div class="col-lg-3">
           <h1 style=" border-style: double; border-color:red; ">TECLADO</h1>
        </div>
        </div>
...
<div style="height: 50px;"></div>
  ...
  <div class="row">
	...
	?>
      ...
      <?php
          if($nro_pagina>1)
              echo "<a style='background-color:#262424; border-radius:5px;' href='teclado.php?num=".($nro_pagina-1)."'> Anterior < </a> ";
       ...
       for ($i=1; $i<=$can_paginas; $i++){
          ...
          if($nro_pagina<$can_paginas)
               echo "<a style='background-color:#262424; border-radius:5px;' href='teclado.php?num=".($nro_pagina+1)."'> Siguiente ></a> ";
