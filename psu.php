...
<div class="container">
    <div style="height: 50px;"></div>
     <h1 class="mt-4 mb-3">Fuente de Poder
        <small></small>
      </h1>
          <div class="row">
        <div class="col-lg-12">
	...
	?>
      ...
      <?php
          if($nro_pagina>1)
              echo "<a style='background-color:#262424; border-radius:5px;' href='psu.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
       ...
       for ($i=1; $i<=$can_paginas; $i++){
          ...
          if($nro_pagina<$can_paginas)
               echo "<a style='background-color:#262424; border-radius:5px;' href='psu.php?num=".($nro_pagina+1)."'> Siguiente ></a> ";
