...
<body>
    ...
    include('conn.php');
     $query=mysqli_query($conn,"select * from product where categoryid = 9 order by product_price");  
    ...
    if(is_numeric($nro_pagina))
       ...
       $query=mysqli_query($conn,"select * from product where categoryid = 9 order by product_price limit $inicio,$reg_por_pagina");  
    ...
    <div class="container">
        ...
        <!-- Page Heading/Breadcrumbs -->
          ...
          <div class="row">
        <div class="col-lg-5">
           <h1 style=" border-style: double; border-color:#1d1d7e; ">Fuente de Poder</h1>
        </div>
        </div>
               <div class="row">
        <div class="col-lg-12">
            <img src="img/Banner_Productos/psu.png" style="width:100%;">
        </div>
        </div>
<div style="height: 50px;"></div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a style="color: #000;" href="index.php">Inicio</a></li>
                <li class="breadcrumb-item active">Fuente de poder</li>
            </ol>  
    ...
    <div id="A_Equipment" class="flex-container">
      ...
      <?php
       if($nro_pagina>1){
          echo "<a style='color:black;' href='psu.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
       }
       for ($i=1; $i<=$can_paginas; $i++)
       {
          if ($i==$nro_pagina){
               ...
               echo "<a style='color:black;' href='psu.php?num=$i'>$i</a> ";
           }
       } 
       if($nro_pagina<$can_paginas){
           echo "<a style='color:black;' href='psu.php?num=".($nro_pagina+1)."'> Siguiente ></a> "; 
       }
       ?>
      </div>
      <!--End Pagination -->
