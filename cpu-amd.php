...
<html lang="en">
  ...
  <head>
    ...
    if(is_numeric($nro_pagina))
       ...
       $query=mysqli_query($conn,"select * from product where categoryid = 3 order by product_price limit $inicio,$reg_por_pagina");  
...
<div class="container">
    <div style="height: 50px;"></div>
     <h1 class="mt-4 mb-3">Procesadores
        <small></small>
      </h1>
          <div class="row">
        <div class="col-lg-12">
            <img src="img/Banner_Productos/Ryzen.jpg" style="width:100%;">
        </div>
        </div>
    <div style="height: 50px;"></div>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Procesadores</li>
      </ol>
    ...
    <!-- colored -->
    <div class="ih-item square colored effect4" style="height:270px;"><a>
	...
	?>
      ...
      <?php
          if($nro_pagina>1)
              echo "<a style='background-color:#262424; border-radius:5px;' href='cpu-amd.php?num=".($nro_pagina-1)."'< Anterior ></a> ";
              
       for ($i=1; $i<=$can_paginas; $i++){
           if ($i==$nro_pagina)
               echo $i." ";
           else 
               echo "<a style='color:black;' href='cpu-amd.php?num=$i'>$i</a> ";
       } 
          
          if($nro_pagina<$can_paginas)
               echo "<a style='background-color:#262424; border-radius:5px;' href='cpu-amd.php?num=".($nro_pagina+1)."'> Siguiente ></a> ";
