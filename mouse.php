...
<body>
    ...
    include('conn.php');
     $query=mysqli_query($conn,"select * from product where categoryid = 17 order by product_price");  
    ...
    if(is_numeric($nro_pagina))
       ...
       $query=mysqli_query($conn,"select * from product where categoryid = 17 order by product_price limit $inicio,$reg_por_pagina");  
    ...
    ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-2">
                    <h1 style=" border-style: double; border-color:#1d1d7e; ">Mouse</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
          ...
          ?>
            ...
            <div align="center">
                <?php
       if($nro_pagina>1){
          echo "<a style='color:black;' href='mouse.php?num=".($nro_pagina-1)."'> Anterior ></a> ";
       }
       for ($i=1; $i<=$can_paginas; $i++)
       {
          if ($i==$nro_pagina){
               ...
               echo "<a style='color:black;' href='mouse.php?num=$i'>$i</a> ";
           }
       } 
       if($nro_pagina<$can_paginas){
           echo "<a style='color:black;' href='mouse.php?num=".($nro_pagina+1)."'> Siguiente ></a> "; 
       }
       ?>
            </div>
            <!--End Pagination -->
